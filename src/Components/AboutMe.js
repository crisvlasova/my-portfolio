...
export default function AboutMe () {
    return (
        <div className='about-me-presentation description'>
            <h2>About me:</h2>
            <h4>I'm Cristina, I'm 20 years old and currently working as a Makeup Artist, Barman and studying
                ...
                environments and solving problems in a fast and creative way.</h4>
        </div>
    )
}